...
<template>
  ...
  >
    ...
    <g v-else-if="name === 'palette'">
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.8 0 1.5-.7 1.5-1.5 0-.4-.2-.8-.4-1.1-.3-.3-.4-.6-.4-1 0-.8.7-1.5 1.5-1.5H16c3.3 0 6-2.7 6-6 0-4.4-4.5-8-10-8z" />
    </g>

    <g v-else-if="name === 'sparkle'">
      <path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3z" />
      <path d="M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8L19 14z" />
      <path d="M5 15l.6 1.6L7 17l-1.6.6L5 19l-.6-1.4L3 17l1.6-.6L5 15z" />
    </g>
    ...
    <g v-else-if="name === 'copy'">
      ...
      <rect x="5" y="5" width="13" height="13" rx="2" ry="2" />
    </g>
    ...
    <g v-else-if="name === 'fullscreen'">
      <path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3" />
    </g>
    <g v-else-if="name === 'exit-fullscreen'">
